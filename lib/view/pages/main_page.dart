...
import 'package:my_project/view/pages/profile_page.dart';
import 'package:my_project/view/pages/settings_page.dart';
                  ...
                  Padding(
                    ...
                    child: Stack(
                      children: [
                        CircleAvatar(
                          radius: 50,
                          backgroundImage: NetworkImage(userData.isNotEmpty
                              ? userData[0]['userImg'] ?? ''
                              : ''),
                        ),
                      ],
